...
export default function Contact() {
    ...
    return (
        <section id='contact' className="contacts-container" data-aos="fade-up" data-aos-duration="800" data-aos-once={true}>
            <div className="contacts inner-wrapper">
                <div className='contact-list-container'>
                    ...
                    <div className='contact-me-btn-container'>
                        <a className='call-btn' href={`tel:${contacts.info.phone}`}>Let's Talk</a>
                        <a className='mail-btn' href={`mailto:${contacts.info.mail}`}>Let's Chat</a>
                    </div>
                    <a
